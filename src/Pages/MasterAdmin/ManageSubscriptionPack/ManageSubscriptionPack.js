            ...
            <div className="modal-dialog modal-dialog-centered" role="document">
              <div className="modal-content">
                <div className="modal-header">
                  <h5 className="modal-title" id="exampleModalCenterTitle" >Add Plan</h5>
                  ...
                  <form>
                    <div className="col">
                      <div className="form-group row">
                        <label htmlFor="inputEmail3" className="col-sm-4 col-form-label">Access Client</label>
                        <div className="col-sm-8">
                          <input type="text" className="form-control" id="inputEmail3" placeholder="Enter total clients" onChange={handleChange} name='AccessClients' value={AddSubPlanData.AccessClients} />
                        </div>
                      </div>
                      <div className="form-group row">
                        <label htmlFor="inputEmail3" className="col-sm-4 col-form-label">Price</label>
                        <div className="col-sm-8">
                          <input type="text" className="form-control" id="inputEmail3" placeholder="Enter price" onChange={handleChange} name='SubPrice' value={AddSubPlanData.SubPrice} />
                        </div>
                      </div>
                      <div className="form-group row">
                        <label htmlFor="inputEmail3" className="col-sm-4 col-form-label">Subtype</label>
                        <div className="col-sm-8">
                          <input type="text" className="form-control" id="inputEmail3" placeholder="Enter client range " onChange={handleChange} name='SubType' value={AddSubPlanData.SubType} />
                        </div>
                      </div>
                    </div>
                  </form>
                ...
                <div className="modal-footer d-flex justify-content-center">
                  ...
                  <button type="button" className="btn btn-warning" onClick={() => SaveSubPlan()}><b>Submit</b></button>
                </div>
              </div>
            </div>
          </div>
                  ...
                  <div>
                    ...
                    <div className="modal fade" id="exampleModalCenter2" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                      <div className="modal-dialog modal-dialog-centered" role="document">
                        <div className="modal-content">
                          <div className="modal-header">
                            <h5 className="modal-title" id="exampleModalCenterTitle">Edit Plan</h5>
                            <button type="button" className="close" data-dismiss="modal" aria-label="Close">
                              <span aria-hidden="true">&times;</span>
                            </button>
                          </div>
                            ...
                            <form>
                              <div className="col">
                                <div className="form-group row">
                                  <label htmlFor="inputEmail3" className="col-sm-4 col-form-label">Access Client</label>
                                  <div className="col-sm-8">
                                    <input type="email" className="form-control" id="inputEmail3" onChange={EdithandleChange} name='AccessClients' value={EditSubPlanData.AccessClients} />
                                  </div>
                                </div>
                                <div className="form-group row">
                                  <label htmlFor="inputEmail3" className="col-sm-4 col-form-label">Price</label>
                                  <div className="col-sm-8">
                                    <input type="email" className="form-control" id="inputEmail3" onChange={EdithandleChange} name='SubPrice' value={EditSubPlanData.SubPrice} />
                                  </div>
                                </div>
                                <div className="form-group row">
                                  <label htmlFor="inputEmail3" className="col-sm-4 col-form-label">Subtype</label>
                                  <div className="col-sm-8">
                                    <input type="email" className="form-control" id="inputEmail3" onChange={EdithandleChange} name='SubType' value={EditSubPlanData.SubType} />
                                  </div>
                                </div>
                              </div>
                            </form>
                          ...
                          <div className="modal-footer d-flex justify-content-center">
                            {/* <button type="button" className="btn btn-secondary" data-dismiss="modal">Close</button> */}
                            <button type="button" className="btn btn-warning" onClick={() => UpdateSubPlan(items.id)}><b>Update</b></button>
                          </div>
                        </div>
                      </div>
                    </div>
