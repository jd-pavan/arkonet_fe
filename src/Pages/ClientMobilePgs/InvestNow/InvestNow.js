...
function InvestNow() {
  ...
  async function sendEmail(clientid, userid, subject, body, category, mobile) {
    ...
    try {
      const response = await fetch(`${url_}/sendemailclient?clientid=${clientid}&userid=${userid}&subject=${subject}&category=${category}&mobile=${mobile}`, requestOptions)
      const result = await response.text();
      if (response.status === 200) {
        swal.close();
        swal.fire({
  ...
  return (
    <div className={`${style.row}`}>
      ...
      >
        ...
        {/* Ad Starts */}
        <div style={{ width: "100%", border: "1px dashed black", height: "30vh", marginTop: "20px", borderRadius: "10px" }}>
          <AdCarousel />
        </div>
        {/* Ad Ends......................................................................................................... */}
