...
const SubLoginRegister = (props) => {
  ...
  const handleNoChange = (e) => {
    ...
    const totalAmountToPayofLogin = newNumber * totalAmountToPay
    // console.log(Math.fround(AmountToPay))
    // console.log(Math.round(totalAmountToPayofLogin))



    // const SingleDayforSUBLogin = 2.7 * UserDays
    // const PlanforSUBLogin = SingleDayforSUBLogin * newNumber
    setAmountofLogin(Math.round(totalAmountToPayofLogin))
    const now = new Date();
