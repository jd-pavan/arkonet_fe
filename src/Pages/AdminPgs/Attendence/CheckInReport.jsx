...
const CheckInReport = () => {
  ...
  const GetCheckInList = async () => {
    try {
      ...
      const response = await fetch(`${url_}/working-time-SubUser-CheckOutList-DateBetween?startDate=${CheckInDate}&endDate=${CheckInDate}&category=Sub User&userid=${user_id}`, requestOptions)
