...
function Footer() {
  ...
  return (
    ...
    <footer className="text-center text-lg-start bg-body-tertiary " style={{ backgroundColor: "black", "color": "#fff" }}>
      ...
      <section className="">
        <div className="container-fluid text-center text-md-start mt-5" style={{ backgroundColor: "black" }}>
